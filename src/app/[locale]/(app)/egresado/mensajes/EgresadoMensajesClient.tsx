      ...
      <div
        className={cn(
          ...
          isMine
            ...
            : 'bg-primary/5 text-foreground rounded-bl-sm border border-primary/20',
        )}
      >
        ...
        <main className="flex flex-col gap-6">
          ...
          {conversaciones.length === 0 ? (
            ...
            <div className="flex border border-border/60 rounded-2xl overflow-hidden bg-card/20 shadow-sm mt-2 h-[calc(100vh-220px)] min-h-[560px]">
              ...
              {selectedConv === null ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center p-8 gap-3">
                  <div className="p-4 bg-gradient-to-br from-magenta/10 to-primary/8 rounded-full text-magenta">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                  {/* Header del chat */}
                  <div className="px-5 py-3.5 border-b border-border/40 flex items-center gap-3 bg-gradient-to-r from-magenta/8 to-primary/5">
                    <ContactAvatar
                  ...
                  <div className="border-t border-border/40 p-4 space-y-2.5 bg-card/10">
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      <Button
                        ...
                        className="rounded-xl shrink-0 h-10 w-10 bg-primary hover:bg-primary/90 text-white"
